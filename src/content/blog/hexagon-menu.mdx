...
<div class="grid my-8 gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
  <div class="flex justify-center">
    #### Not Rotated
  </div>
  <div class="flex justify-center md:order-3 lg:order-2 xl:order-3">
    <HexMenu
  ...
  <div class="flex justify-center md:order-2 lg:order-3 xl:order-2">
    #### Rotated
  </div>
  <div class="flex justify-center order-4">
    <HexMenu
