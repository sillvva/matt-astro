...
updated: 2024-03-23T14:26:12.942Z
image: $/assets/images/forms.webp
tags:
  - TypeScript
  - SvelteKit
---
import MultiTabbedCode from "$/components/markdown/multi-tabbed-code.astro";
...
<TabbedCode filename="src/lib/util.ts">
```ts
...
<TabbedCode filename="src/server/actions/logs.ts">
```ts
...
<TabbedCode filename=".../[logId]/+page.server.ts">
```ts
...
<MultiTabbedCode>
<Fragment slot="handle-1">.../[dmId]/+page.server.ts</Fragment>
...
<Fragment slot="handle-2">../[dmId]/+page.svelte</Fragment>
