...
I have created a set of wrapper types that identify `.length` paths and check whether they are branded types. If they are, the wrapper type will return the correct branded path instead.

You can read about these helpers in this separate [post](/blog/superforms-branded-leaves).