...
Guarded remote functions ensure that your remote functions are only called by authenticated users. This is especially useful in combination with the lint rule to enforce guarded remote functions.
