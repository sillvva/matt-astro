...
<TabbedCode filename=".../+layout.server.ts">
```ts
...
<TabbedCode filename=".../characters/+layout.server.ts">
```ts
export const load = async (event) => {
...
<TabbedCode filename=".../characters/[characterId]/+layout.server.ts">
```ts
...
<TabbedCode filename="Breadcrumbs.svelte">
```svelte
<script lang="ts">
