...
image: https://slxazldgfeytirfrculz.supabase.co/storage/v1/object/public/images/svelte-supabase.webp
tags:
  - Authentication
  - Tutorial
---
...
![Auth Settings](https://slxazldgfeytirfrculz.supabase.co/storage/v1/object/public/images/auth-settings.webp)

Then scroll down and select your preferred auth provider(s).

![Auth Providers:no-aspect](https://slxazldgfeytirfrculz.supabase.co/storage/v1/object/public/images/auth-providers.webp)
